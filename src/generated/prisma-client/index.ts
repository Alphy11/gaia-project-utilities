...
export type Faction = "ITARS" | "TERRANS" | "XENOS" | "TAKLONS";
...
export interface UserScalarWhereInput {
  ...
  faction_not?: Maybe<Faction>;
  faction_in?: Maybe<Faction[] | Faction>;
  faction_not_in?: Maybe<Faction[] | Faction>;
  points?: Maybe<Int>;
  ...
  isMyTurn?: Maybe<Boolean>;
  isMyTurn_not?: Maybe<Boolean>;
...
export interface UserPreviousValuesSubscription
  ...
  faction: () => Promise<AsyncIterator<Faction>>;
  points: () => Promise<AsyncIterator<Int>>;
  passed: () => Promise<AsyncIterator<Boolean>>;
  isMyTurn: () => Promise<AsyncIterator<Boolean>>;
}
...
export const Prisma = makePrismaClientClass<ClientConstructor<Prisma>>({
  typeDefs,
  models,
  endpoint: `https://us1.prisma.sh/public-spotkicker-848/gaia-project-utilities/dev`
});
